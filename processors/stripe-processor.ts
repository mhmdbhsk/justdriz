...
import type { JustdrizProcessor, StripeProcessorOpts } from "../lib/types";
import {
	addJustDComponents,
...
export class StripeProcessor implements JustdrizProcessor {
	...
	justDComponents: string[] = ["card", "badge", "alert"];
